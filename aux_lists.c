...
sep_list *add_sep_node_end(alias_t **head, char *name, char *value);
void free_sep_list(sep_list *head);
line_list *add_sep_node_end(line_list **head, char *dir);
...
/**
 * add_sep_node_end - Adds a node to the end of a list_t linked list.
 * @head: A pointer to the head of the list_t list.
